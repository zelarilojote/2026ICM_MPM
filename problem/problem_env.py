...
import numpy as np
from cost.cost import calculate_total_costs  
from cost.environmental_cost import calculate_total_environmental_cost

class LunarLogisticsProblem_env(BaseProblem):
